...
layout: page
title: Submit
description: Submission instructions and links
navorder: 4
---
...
- **Relevance** to CAMCAD and the theme of collaborative agency  
- **Originality** of the ideas, methods, findings, or designs  
- **Potential contribution to workshop discussion** (e.g., questions raised, implications, tensions, takeaways)  
- **Clarity** of the submission and strength of its framing/argument  
...
- Leave **author names and affiliations blank**
- Leave the **acknowledgements section blank**
- Remove identifying references in the body text where possible (e.g., “our lab at X University”)
- Ensure **no identifying metadata** is embedded in the file (e.g., the ‘Authors’ field in your word processor’s ‘Save As’ dialog box)
- Anonymise **images** that reveal identity (e.g., faces, institutional logos)
